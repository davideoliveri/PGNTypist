...
export const UI_TRANSLATIONS: { [lang in Language]: { [key: string]: string } } = {
  en: {
    ...
    'export.copy': 'Copy PGN (moves)',
    'export.download': 'Download PGN with comments',
    'export.downloadMoves': 'Download PGN (moves)',
...
Analyze on Lichess with one click`,
    ...
    'export.copyWithComments': 'Copy PGN with comments',
    'board.showLastMove': 'Last move',
    'board.showSelectedMove': 'Selected move',
    'nav.start': 'Go to start',
  ...
  es: {
    ...
    'export.copy': 'Copiar PGN (jugadas)',
    'export.download': 'Descargar PGN con comentarios',
    'export.downloadMoves': 'Descargar PGN (jugadas)',
...
Analiza en Lichess con un clic`,
    ...
    'export.copyWithComments': 'Copiar PGN con comentarios',
    'board.showLastMove': 'Última jugada',
    'board.showSelectedMove': 'Jugada seleccionada',
  },
  it: {
    'app.placeholder': 'Inserisci mossa (es. e4, Cf3)',
    'export.copy': 'Copia PGN (mosse)',
    'export.download': 'Scarica PGN con commenti',
    'export.downloadMoves': 'Scarica PGN (mosse)',
...
Analizza su Lichess con un clic`,
    ...
    'export.copyWithComments': 'Copia PGN con commenti',
    'board.showLastMove': 'Ultima mossa',
    'board.showSelectedMove': 'Mossa selezionata',
  },
  fr: {
    'app.placeholder': 'Entrez un coup (ex. e4, Cf3)',
    'export.copy': 'Copier PGN (coups)',
    'export.download': 'Télécharger PGN avec commentaires',
    'export.downloadMoves': 'Télécharger PGN (coups)',
    'export.copied': 'Copié !',
    'export.fen': 'FEN',
...
Analysez sur Lichess en un clic`,
    ...
    'export.copyWithComments': 'Copier PGN avec commentaires',
    'board.showLastMove': 'Dernier coup',
    'board.showSelectedMove': 'Coup sélectionné',
  },
  ca: {
    'app.placeholder': 'Introdueix jugada (ex. e4, Cf3)',
    'export.copy': 'Copiar PGN (jugades)',
    'export.download': 'Descarregar PGN amb comentaris',
    'export.downloadMoves': 'Descarregar PGN (jugades)',
...
Analitza a Lichess amb un clic`,
    ...
    'export.copyWithComments': 'Copiar PGN amb comentaris',
  ...
  pt: {
    ...
    'export.copy': 'Copiar PGN (lances)',
    'export.download': 'Baixar PGN com comentários',
    'export.downloadMoves': 'Baixar PGN (lances)',
    'export.copied': 'Copiado!',
    'export.fen': 'FEN',
    'export.copyFen': 'Copiar',
...
Analise no Lichess com um clique`,
    ...
    'export.copyWithComments': 'Copiar PGN com comentários',
    'board.showLastMove': 'Último lance',
    'board.showSelectedMove': 'Lance selecionado',
  },
  el: {
    'app.placeholder': 'Εισάγετε κίνηση (π.χ. e4, Ιf3)',
    'export.copy': 'Αντιγραφή PGN (κινήσεις)',
    'export.download': 'Λήψη PGN με σχόλια',
    'export.downloadMoves': 'Λήψη PGN (κινήσεις)',
...
Αναλύστε στο Lichess με ένα κλικ`,
    ...
    'export.copyWithComments': 'Αντιγραφή PGN με σχόλια',
    'board.showLastMove': 'Τελευταία κίνηση',
    'board.showSelectedMove': 'Επιλεγμένη κίνηση',
  },
  ru: {
    'app.placeholder': 'Введите ход (напр. e4, Кf3)',
    'export.copy': 'Копировать PGN (ходы)',
    'export.download': 'Скачать PGN с комментариями',
    'export.downloadMoves': 'Скачать PGN (ходы)',
...
Анализируйте на Lichess одним кликом`,
    ...
    'export.copyWithComments': 'Копировать PGN с комментариями',
    'board.showLastMove': 'Последний ход',
    'board.showSelectedMove': 'Выбранный ход',
  },
  nl: {
    'app.placeholder': 'Voer zet in (bijv. e4, Pf3)',
    'export.copy': 'Kopieer PGN (zetten)',
    'export.download': 'Download PGN met reacties',
    'export.downloadMoves': 'Download PGN (zetten)',
...
Analyseer op Lichess met één klik`,
    ...
    'export.copyWithComments': 'Kopieer PGN met reacties',
    'board.showLastMove': 'Laatste zet',
    'board.showSelectedMove': 'Geselecteerde zet',
  },
  no: {
    'app.placeholder': 'Skriv trekk (f.eks. e4, Sf3)',
    'export.copy': 'Kopier PGN (trekk)',
    'export.download': 'Last ned PGN med kommentarer',
    'export.downloadMoves': 'Last ned PGN (trekk)',
...
Analyser på Lichess med ett klikk`,
    ...
    'export.copyWithComments': 'Kopier PGN med kommentarer',
    'board.showLastMove': 'Siste trekk',
    'board.showSelectedMove': 'Valgt trekk',
  },
  sv: {
    'app.placeholder': 'Ange drag (t.ex. e4, Sf3)',
    'export.copy': 'Kopiera PGN (drag)',
    'export.download': 'Ladda ner PGN med kommentarer',
    'export.downloadMoves': 'Ladda ner PGN (drag)',
...
Analysera på Lichess med ett klick`,
    ...
    'export.copyWithComments': 'Kopiera PGN med kommentarer',
    'board.showLastMove': 'Senaste draget',
    'board.showSelectedMove': 'Valt drag',
  },
  fi: {
    'app.placeholder': 'Syötä siirto (esim. e4, Rf3)',
    'export.copy': 'Kopioi PGN (siirrot)',
    'export.download': 'Lataa PGN kommenteilla',
    'export.downloadMoves': 'Lataa PGN (siirrot)',
...
Analysoi Lichessissä yhdellä napsautuksella`,
    ...
    'export.copyWithComments': 'Kopioi PGN kommenteilla',
    'board.showLastMove': 'Viimeisin siirto',
    'board.showSelectedMove': 'Valittu siirto',
  },
};
